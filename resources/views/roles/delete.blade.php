...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <em class="text-red-800">TODO: Add Cancel / Delete confirmation buttons</em>
                        ...
                        <dd class="col-span-5">
                            @if(!empty($rolePermissions))
                                @foreach($rolePermissions as $permission)
                                    <span
                                        class="inline-block rounded bg-warmGray-600 text-warmGray-50 text-sm p-1 py-0 mr-0.5 text-sm">{{ $permission->name }}</span>
                                @endforeach
                            @endif
                        </dd>
                    </dl>
